                        ...
                        if (
                            ...
                            if (response.results.results.length) {
                                ...
                                for (var i = 0; i < response.results.results.length; i++) {
                                    ...
                                    var myDate = new Date(res.date_pub_uni_articles);  
                                    ...
                                    $toPut.push(
                                        "<div class='item item-mans'>"
                                            ...
                                            + "<div class='liveana-card-meta'><a class='liveana_goto_article' href='" + res.link_articles.replace(/'/g,"%27") + "' target='_blank'>עבור לכתבה</a><span class='datepub'>" + myDate + "</span></div>"
